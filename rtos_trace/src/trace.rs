...
pub fn task_exec_begin(id: u32) {
    #[cfg(feature = "trace_impl")]
    unsafe {
        _rtos_trace_task_exec_begin(id)
    }
}
#[inline]
...
pub fn task_ready_begin(id: u32) {
    #[cfg(feature = "trace_impl")]
    unsafe {
        _rtos_trace_task_ready_begin(id)
    }
}
#[inline]
...
pub fn isr_exit_to_scheduler() {
    #[cfg(feature = "trace_impl")]
    unsafe {
        _rtos_trace_isr_exit_to_scheduler()
    }
}
...
pub fn task_send_info(id: u32, info: TaskInfo) {
    #[cfg(feature = "trace_impl")]
    unsafe {
        _rtos_trace_task_send_info(id, info)
    }
}
#[inline]
pub fn time() -> u64 {
